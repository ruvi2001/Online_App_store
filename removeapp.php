...
<html>
<head>
    <title>AppStore-AdminPage-RemoveApps</title>
        ...
        <nav>
            ...
            <li class="logo">
                ...
                <div class="items">
                    ...
                    <li><a href="library.php"><i class="fa fa-shopping-cart"></i> Libaray</a></li>
        ...
        <div class="removebookform">
            <form action="">
                    <div class="col">
                        ...
                        <div class="inputBox">
                            <span>App ID :</span>
                            <input type="text" placeholder="xxxx" name="bookid">
                        </div>
                    </div>
                <input type="submit" value="Remove App" class="submit-btn">
            </form>
        </div>
